...
'Also write a \"video\" block for the TikTok version of each story. Measured on 13.09: hooks framed as a CONSEQUENCE FOR THE VIEWER\'S OWN MONEY hold 2.5 s of watch time, headline-style or shock-number hooks only 1.7 s. So: \"hook\" = 3-6 words, ALL CAPS, addressed to the viewer personally, stating what this news does to THEIR money (e.g. STABLECOINS ARE WEAKENING YOUR CURRENCY, YOUR BITCOIN LOAN CAN BE LENT OUT); a number goes in only if the number itself IS the consequence; no hyphens, no abbreviations, no company names unless everyone knows them. \"lead\" = the first sentence of the caption, again the consequence for the viewer, not a headline, max 140 characters. \"question\" = one short question that invites a comment (\"Would you still hold it?\"). All three in plain English.\n\n' +
...
'[{"slug":"kebab-case-slug","category":"crypto","emoji":"X","video":{"hook":"...","lead":"...","question":"..."},"i18n":{"en":{"title":"...","excerpt":"...","body":["p1","p2","p3","p4","p5","p6"]}, ...all 17 langs}}]\n\n' +
